...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BOBOMB_BUDDY,            RCP_HmsEnemybom_basedata),
...
const LevelScript script_func_global_2[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_HOOT,                    RCP_birdHierarchy),
...
const LevelScript script_func_global_10[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAD_PIANO,               RCP_HmsEnemypiano_base_data),
