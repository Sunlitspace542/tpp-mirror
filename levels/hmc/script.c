...
const LevelScript level_hmc_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_HMC_WOODEN_DOOR,          RCP_HmsDoor1),
    LOAD_MODEL_FROM_GEO(MODEL_HMC_METAL_DOOR,           RCP_HmsDoor2),
    LOAD_MODEL_FROM_GEO(MODEL_HMC_HAZY_MAZE_DOOR,       RCP_HmsDoor3),
