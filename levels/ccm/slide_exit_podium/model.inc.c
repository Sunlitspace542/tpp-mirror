...
static const Lights1 ccm_seg7_lights_0702ACE8 = gdSPDefLights1(
    0x0c, 0x0c, 0x0c,
    0x33, 0x33, 0x33, 0x28, 0x28, 0x28
);

// 0x0702AD00 - 0x0702AD18
static const Lights1 ccm_seg7_lights_0702AD00 = gdSPDefLights1(
    0x1d, 0x1d, 0x1d,
    0x77, 0x77, 0x77, 0x28, 0x28, 0x28
);

// 0x0702AD18 - 0x0702AD30
static const Lights1 ccm_seg7_lights_0702AD18 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0702AD30 - 0x0702B530
ALIGNED8 static const u8 ccm_seg7_texture_0702AD30[] = {
#include "levels/ccm/slide.exit.rgba16.inc.c"
};

// 0x0702B530 - 0x0702B570
static const Vtx ccm_seg7_vertex_0702B530[] = {
...
static const Vtx ccm_seg7_vertex_0702B570[] = {
...
static const Vtx ccm_seg7_vertex_0702B670[] = {
...
static const Vtx ccm_seg7_vertex_0702B770[] = {
...
static const Vtx ccm_seg7_vertex_0702B870[] = {
    {{{   102,    205,   -101}, 0, {  5590,  -7698}, {0x00, 0x7f, 0x00, 0xff}}},
...
static const Vtx ccm_seg7_vertex_0702B970[] = {
    {{{   205,    205,    205}, 0, {  4056,  -7186}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   102,    205,    102}, 0, {  4568,  -7698}, {0x00, 0x7f, 0x00, 0xff}}},
...
static const Gfx ccm_seg7_dl_0702B9D0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, ccm_seg7_texture_0702AD30),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&ccm_seg7_lights_0702ACE8.l, 1),
    gsSPLight(&ccm_seg7_lights_0702ACE8.a, 2),
    gsSPVertex(ccm_seg7_vertex_0702B530, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsSPLight(&ccm_seg7_lights_0702AD00.l, 1),
    gsSPLight(&ccm_seg7_lights_0702AD00.a, 2),
    gsSPVertex(ccm_seg7_vertex_0702B570, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  7,  5, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 11,  9, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPLight(&ccm_seg7_lights_0702AD18.l, 1),
    gsSPLight(&ccm_seg7_lights_0702AD18.a, 2),
    gsSPVertex(ccm_seg7_vertex_0702B670, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  6,  8,  9, 0x0),
    gsSP2Triangles(10, 11, 12, 0x0, 13, 14, 15, 0x0),
    gsSPVertex(ccm_seg7_vertex_0702B770, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
    gsSP2Triangles( 4,  5,  6, 0x0,  4,  6,  7, 0x0),
    gsSP2Triangles( 8,  9, 10, 0x0,  8, 11,  9, 0x0),
    gsSP2Triangles(12, 13, 14, 0x0, 12, 14, 15, 0x0),
    gsSPVertex(ccm_seg7_vertex_0702B870, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7,  9, 10, 0x0, 11, 12, 13, 0x0),
    gsSP2Triangles(11, 13, 14, 0x0,  0, 15,  1, 0x0),
    gsSPVertex(ccm_seg7_vertex_0702B970, 6, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSPEndDisplayList(),
};

// 0x0702BB60 - 0x0702BBD0
const Gfx ccm_seg7_dl_0702BB60[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(ccm_seg7_dl_0702B9D0),
