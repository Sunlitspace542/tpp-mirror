...
static const Lights1 ccm_seg7_lights_0701D888 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x0701D8A0 - 0x0701D9A0
static const Vtx ccm_seg7_vertex_0701D8A0[] = {
...
static const Vtx ccm_seg7_vertex_0701D9A0[] = {
    {{{ -6389,  -1533,  -5233}, 0, {     0,      0}, {0x59, 0x00, 0x59, 0xff}}},
...
static const Vtx ccm_seg7_vertex_0701DA80[] = {
...
static const Gfx ccm_seg7_dl_0701DAE0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, mountain_09000800),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 64 * 32 - 1, CALC_DXT(64, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&ccm_seg7_lights_0701D888.l, 1),
    gsSPLight(&ccm_seg7_lights_0701D888.a, 2),
    gsSPVertex(ccm_seg7_vertex_0701D8A0, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
    gsSP2Triangles( 1,  4,  3, 0x0,  0,  2,  5, 0x0),
    gsSP2Triangles( 6,  0,  5, 0x0,  7,  6,  8, 0x0),
    gsSP2Triangles( 6,  5,  8, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles(10, 11, 12, 0x0, 13, 14, 15, 0x0),
    gsSPVertex(ccm_seg7_vertex_0701D9A0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 3,  5,  6, 0x0,  7,  8,  9, 0x0),
    gsSP2Triangles( 7,  9, 10, 0x0, 11, 12, 13, 0x0),
    gsSPVertex(ccm_seg7_vertex_0701DA80, 6, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSPEndDisplayList(),
};

// 0x0701DBB8 - 0x0701DC60
const Gfx ccm_seg7_dl_0701DBB8[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(ccm_seg7_dl_0701DAE0),
