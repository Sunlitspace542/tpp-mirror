...
static const Vtx ccm_seg7_vertex_07024AB0[] = {
...
static const Vtx ccm_seg7_vertex_07024B90[] = {
...
static const Gfx ccm_seg7_dl_07024C00[] = {
    gsSPVertex(ccm_seg7_vertex_07024AB0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  4, 0x0),
    gsSP2Triangles( 0,  5,  3, 0x0,  2,  6,  0, 0x0),
    gsSP2Triangles( 7,  8,  9, 0x0,  9, 10, 11, 0x0),
    gsSP2Triangles( 9, 11, 12, 0x0,  9, 13,  7, 0x0),
    gsSPVertex(ccm_seg7_vertex_07024B90, 7, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  4, 0x0),
...
const Gfx ccm_seg7_dl_07024C78[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPDisplayList(ccm_seg7_dl_07024C00),
    gsDPPipeSync(),
