...
static const Vtx wf_seg7_vertex_07009E48[] = {
    ...
    {{{     8,   1400,     13}, 0, {   990, -19972}, {0x6f, 0x00, 0x3c, 0xff}}},
    {{{     8,      0,     13}, 0, {   990,    990}, {0x6f, 0x00, 0x3c, 0xff}}},
    {{{    -7,   1400,    -12}, 0, {   156,   1020}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{   -14,   1400,      0}, 0, {   768,   1020}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    -7,   1400,     13}, 0, {  1076,    490}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     8,   1400,     13}, 0, {   768,    -40}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{    15,   1400,      0}, 0, {   156,    -40}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     8,   1400,    -12}, 0, {  -150,    490}, {0x00, 0x7f, 0x00, 0xff}}},
    {{{     8,      0,     13}, 0, {   990,    990}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    -7,   1400,     13}, 0, {   480, -19972}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    -7,      0,     13}, 0, {   480,    990}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    -7,      0,     13}, 0, {   480,    990}, {0x91, 0x00, 0x3c, 0xff}}},
    {{{   -14,   1400,      0}, 0, {     0, -19972}, {0x91, 0x00, 0x3c, 0xff}}},
    {{{   -14,      0,      0}, 0, {     0,    990}, {0x91, 0x00, 0x3c, 0xff}}},
    {{{    -7,   1400,     13}, 0, {   480, -19972}, {0x91, 0x00, 0x3c, 0xff}}},
};

// 0x07009F48 - 0x0700A048
static const Vtx wf_seg7_vertex_07009F48[] = {
    {{{     8,      0,     13}, 0, {   990,    990}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{     8,   1400,     13}, 0, {   990, -19972}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{    -7,   1400,     13}, 0, {   480, -19972}, {0x00, 0x00, 0x7f, 0xff}}},
    {{{   -14,      0,      0}, 0, {  3034,    990}, {0x93, 0x00, 0xc1, 0xff}}},
    {{{   -14,   1400,      0}, 0, {  3034, -19972}, {0x93, 0x00, 0xc1, 0xff}}},
    {{{    -7,   1400,    -12}, 0, {  2524, -19972}, {0x93, 0x00, 0xc1, 0xff}}},
    {{{    15,      0,      0}, 0, {  1502,    990}, {0x6f, 0x00, 0x3c, 0xff}}},
    {{{    15,   1400,      0}, 0, {  1502, -19972}, {0x6f, 0x00, 0x3c, 0xff}}},
    {{{     8,   1400,     13}, 0, {   990, -19972}, {0x6f, 0x00, 0x3c, 0xff}}},
    {{{     8,      0,    -12}, 0, {  2012,    990}, {0x6d, 0x00, 0xc1, 0xff}}},
    {{{    15,   1400,      0}, 0, {  1502, -19972}, {0x6d, 0x00, 0xc1, 0xff}}},
    {{{    15,      0,      0}, 0, {  1502,    990}, {0x6d, 0x00, 0xc1, 0xff}}},
    {{{     8,   1400,    -12}, 0, {  2012, -19972}, {0x6d, 0x00, 0xc1, 0xff}}},
    {{{    -7,      0,    -12}, 0, {  2524,    990}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     8,   1400,    -12}, 0, {  2012, -19972}, {0x00, 0x00, 0x81, 0xff}}},
...
static const Vtx wf_seg7_vertex_0700A048[] = {
    {{{    -7,      0,    -12}, 0, {  2524,    990}, {0x00, 0x00, 0x81, 0xff}}},
    {{{    -7,   1400,    -12}, 0, {  2524, -19972}, {0x00, 0x00, 0x81, 0xff}}},
    {{{     8,   1400,    -12}, 0, {  2012, -19972}, {0x00, 0x00, 0x81, 0xff}}},
    {{{   -14,      0,      0}, 0, {  3034,    990}, {0x93, 0x00, 0xc1, 0xff}}},
    {{{    -7,   1400,    -12}, 0, {  2524, -19972}, {0x93, 0x00, 0xc1, 0xff}}},
...
static const Gfx wf_seg7_dl_0700A0A8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, wf_seg7_texture_07006500),
    gsDPLoadSync(),
