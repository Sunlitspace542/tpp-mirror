...
const LevelScript level_intro_entry_1[] = {
    ...
    LOAD_RAW(/*seg*/ 0x07, _intro_segment_7SegmentRomStart, _intro_segment_7SegmentRomEnd),
     ...
     * allowing the next area with the Mario head to be loaded, which was most likekly it's original intention here.
     */
    CMD2A(/*unk2*/ 1),
    SLEEP(/*frames*/ 2),
