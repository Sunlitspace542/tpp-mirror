...
void *gMarioAnimationBuffer;
void *gLuigiAnimationBuffer;
void *D_80339CF4;
struct MarioAnimation gMarioAnimation;
struct MarioAnimation gLuigiAnimation;
...
void setup_game_memory(void) {
    ...
    gMarioAnimationBuffer = main_pool_alloc(0x4000, MEMORY_POOL_LEFT);
    gLuigiAnimationBuffer = main_pool_alloc(0x4000, MEMORY_POOL_RIGHT);
    set_segment_base_addr(17, (void *) gMarioAnimationBuffer);
    set_segment_base_addr(18, (void *) gLuigiAnimationBuffer);
    func_80278A78(&gMarioAnimation, gMarioAnims, gMarioAnimationBuffer);
    func_80278A78(&gLuigiAnimation, gMarioAnims, gLuigiAnimationBuffer);
