...
struct Struct80331A54 D_80331A54[][5] = {
    {
        { NULL, MODEL_BITS_STAIRCASE_FRAME4 },
        { NULL, MODEL_BITS_STAIRCASE_FRAME3 },
        { NULL, MODEL_BITS_STAIRCASE_FRAME2 },
        { NULL, MODEL_BITS_STAIRCASE_FRAME1 },
        { NULL, MODEL_BITS_STAIRCASE },
    },
    {
        { NULL, MODEL_BITDW_STAIRCASE },
        { NULL, MODEL_BITDW_STAIRCASE_FRAME1 },
        { NULL, MODEL_BITDW_STAIRCASE_FRAME2 },
        { NULL, MODEL_BITDW_STAIRCASE_FRAME3 },
        { NULL, MODEL_BITDW_STAIRCASE_FRAME4 },
    },
    {
