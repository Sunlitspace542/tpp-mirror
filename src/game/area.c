...
const BehaviorScript *sWarpBhvSpawnTable[] = {
    bhvDoorWarp,          bhvStar,    bhvExitPodiumWarp, bhvWarp,    bhvWarpPipe,
    bhvFadingWarp,        bhvWarps60, bhvWarps64,        bhvWarps68, bhvWarps6C,
    bhvDeathWarp,         bhvWarps74, bhvWarps78,        bhvWarps94, bhvWarps7C,
    bhvPaintingDeathWarp, bhvWarps88, bhvWarps84,        bhvWarps8C, bhvWarps90,
};
